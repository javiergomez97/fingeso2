                  ...
                  <v-row>
                    <v-col cols="12" md="8">
                      <v-card-text class="mt-12">
                        ...
                        <h4 class="text-center mt-4">Ingrese sus datos para iniciar sesión</h4>
                        <v-form>
                          <v-text-field
                            label="Email"
                            name="Email"
                    ...
                    <v-col cols="12" md="4" class="teal accent-3">
                      <v-card-text class="white--text mt-12">
                        ...
                        <h5
                          class="text-center"
                        >Ingresa tus datos personales y empieza a tranajar junto a nosotros</h5>
                      </v-card-text>
                  ...
                  <v-row class="fill-height">
                    <v-col cols="12" md="4" class="teal accent-3">
                      <v-card-text class="white--text mt-12">
                        ...
                        <h5
                          class="text-center"
                        >Para mantenerse conectado con nosotros por favor ingrese sus datos personales</h5>
                      </v-card-text>
                      <div class="text-center">
                    ...
                    <v-col cols="12" md="8">
                      <v-card-text class="mt-12">
                        <h1 class="text-center display-2 teal--text text--accent-3">Crear una Cuenta</h1>
                        <div class="text-center mt-4">
                          <v-btn class="mx-2" fab color="black" outlined>
                            <v-icon>fab fa-facebook-f</v-icon>
                          </v-btn>
